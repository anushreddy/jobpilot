    ...
    <div className="flex flex-col items-center">
      <svg viewBox="0 0 200 130" className="w-52 h-auto">
        ...
        {[0, 25, 50, 75, 100].map((tick) => {
          ...
          return (
            <line key={tick} x1={x1} y1={y1} x2={x2} y2={y2} stroke="rgba(255,255,255,0.2)" strokeWidth="2" />
          );
        })}
        {/* Needle */}
        <g transform={`rotate(${angle}, 100, 110)`}>
          ...
          <circle cx="100" cy="110" r="3" fill="#0a0a14" />
        </g>
        {/* Score */}
        <text x="100" y="95" textAnchor="middle" fill="white" fontSize="28" fontWeight="700">
          {clampedScore}
        </text>
        ...
        {/* Labels */}
        <text x="16" y="126" fill="rgba(255,255,255,0.4)" fontSize="9">0</text>
        <text x="182" y="126" fill="rgba(255,255,255,0.4)" fontSize="9" textAnchor="end">100</text>
      </svg>
    </div>
  );
}
